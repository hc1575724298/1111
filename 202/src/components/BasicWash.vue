<template>
  <div class="model" v-if="title_type==1">
    <div class="step-name">
      {{$t("language.step")}}:
      <input class="input-step-name" v-model="wash.step_name" @blur="saveData()" />
    </div>
    ...
    <div class="step-name">
      ...
      <input class="input-step-name" v-model="wash.volume" @blur="saveData()" />
    </div>
    <div class="step-name">
      {{$t("language.mix_time")}}:
      <input class="input-step-name" v-model="wash.mix_time" @blur="saveData()" />
    </div>
    <div class="step-name">
      {{$t("language.mix_speed")}}:
      <input class="input-step-name" v-model="wash.mix_speed" @blur="saveData()" />
    </div>
    <div class="step-name">
      {{$t("language.mix_height")}}:
      <input class="input-step-name" v-model="wash.mix_height" @blur="saveData()" />
    </div>
    <div class="step-name">
      {{$t("language.mix_volume")}}:
      <input class="input-step-name" v-model="wash.mix_volume" @blur="saveData()" />
    </div>
  </div>
  ...
  <div v-else-if="title_type==2" class="model">
    ...
    <div v-if="wash.magnet_type=='tip'">
      <div class="step-name">
        {{$t("language.interval_stay")}}:
        <input class="input-step-name" v-model="wash.interval_stay_time" @blur="saveData()" />
      </div>
      <div class="step-name">
        {{$t("language.cycle_1_99")}}:
        <input class="input-step-name" v-model="wash.cycle" @blur="saveData()" />
      </div>
      <div class="step-name">
        {{$t("language.beat_speed")}}:
        <input class="input-step-name" v-model="wash.beat_speed" @blur="saveData()" />
      </div>
      <div class="step-name">
        {{$t("language.dry_time")}}:
        <input class="input-step-name" v-model="wash.drying_time" @blur="saveData()" />
      </div>
      <div class="step-name">
        {{$t("language.expected_magnetic")}}:
        <div class="expect-div" @blur="saveData()">{{wash.expected_magnetic_total_time}}</div>
      </div>
    </div>
    <div v-if="wash.magnet_type=='sleeve'">
      <div class="step-name">
        {{$t("language.every_magnetic")}}:
        <input class="input-step-name" v-model="wash.every_magnetic_time" @blur="saveData()" />
      </div>
      <div class="step-name">
        {{$t("language.liquid_level")}}:
        <input class="input-step-name" v-model="wash.liquid_level_magnetic_time" @blur="saveData()" />
      </div>
      <div class="step-name">
        {{$t("language.cycle_1_99")}}:
        <input class="input-step-name" v-model="wash.cycle" @blur="saveData()" />
      ...
      <div class="step-name">
        ...
        <input class="input-step-name" v-model="wash.magnetic_speed" @blur="saveData()" />
      </div>
      <div class="step-name">
        {{$t("language.lowest_magnetic")}}:
        <input class="input-step-name" @blur="saveData()" v-model="wash.lowest_magnetic_position" />
      </div>
      <div class="step-name">
        {{$t("language.dry_time")}}:
        <input class="input-step-name" v-model="wash.drying_time" @blur="saveData()" />
      ...
      <div class="step-name">
        ...
        <input class="input-step-name" @blur="saveData()" v-model="wash.drying_position" />
      </div>
      <div class="step-name">
        {{$t("language.expected_magnetic")}}:
        <div class="expect-div">{{wash.expected_magnetic_total_time}}</div>
      </div>
      <div class="step-name">
      ...
      <div class="step-name">
        {{$t("language.mix_time")}}:
        <input class="input-step-name" @blur="saveData()" v-model="wash.mix_time" />
      </div>
      <div class="step-name">
        {{$t("language.mix_height")}}:
        <input class="input-step-name" @blur="saveData()" v-model="wash.mix_height" />
      </div>
      <div class="step-name">
        {{$t("language.mix_volume")}}:
        <input class="input-step-name" @blur="saveData()" v-model="wash.mix_volume" />
      </div>
    </div>
  </div>
</template>
...
<script>
  export default {
    ...
    methods: {
      ...
      getData() {
        this.wash = this.$store.getters.protocol.steps[this.order - 1]
      ...
      saveData() {
        ...
        protocol.steps[this.order - 1] = this.wash
        this.$store.commit('setProtocol', protocol)
