<template>
  <div class="model" v-if="title_type==1">
    <div class="step-name">
      {{$t("language.step")}}:
      <input class="input-step-name" v-model="lysis.step_name" @blur="saveData()" />
    </div>
    ...
    <div class="step-name">
      ...
      <input class="input-step-name" v-model="lysis.volume" @blur="saveData()" />
    </div>
    <div class="step-name">
      {{$t("language.mix_time")}}:
      <input class="input-step-name" v-model="lysis.mix_time" @blur="saveData()" />
    </div>
    <div class="step-name">
      {{$t("language.mix_speed")}}:
      <input class="input-step-name" v-model="lysis.mix_speed" @blur="saveData()" />
    </div>
    <div class="step-name">
      {{$t("language.mix_height")}}:
      <input class="input-step-name" v-model="lysis.mix_height" @blur="saveData()" />
    </div>
    <div class="step-name">
      {{$t("language.mix_volume")}}:
      <input class="input-step-name" v-model="lysis.mix_volume" @blur="saveData()" />
    </div>
    <div>
      <div v-if="lysis.well!=2">
        ...
        <div class="step-name" style="margin-bottom: 10px;">
          ...
          <input class="input-step-name" v-model="lysis.temperature" @blur="saveData()" />
        </div>
        <div class="step-name" style="margin-bottom: 10px;">
        ...
        <div class="warning" v-if="lysis.pre_heating==1">
          ...
          <input class="warning-input" v-model="lysis.pre_heating_seconds" @blur="saveData()" />
        </div>
        <div class="step-name" style="margin-bottom: 10px;">
  ...
  <div v-else-if="title_type==2" class="model">
    ...
    <div v-if="lysis.magnet_type=='tip'">
      <div class="step-name">
        {{$t("language.interval_stay")}}:
        <input class="input-step-name" v-model="lysis.interval_stay_time" @blur="saveData()" />
      </div>
      <div class="step-name">
        {{$t("language.cycle_1_99")}}:
        <input class="input-step-name" v-model="lysis.cycle" @blur="saveData()" />
      </div>
      <div class="step-name">
        {{$t("language.beat_speed")}}:
        <input class="input-step-name" v-model="lysis.beat_speed" @blur="saveData()" />
      </div>
      <div class="step-name">
        {{$t("language.dry_time")}}:
        <input class="input-step-name" v-model="lysis.drying_time" @blur="saveData()" />
      </div>
      <div class="step-name">
        {{$t("language.expected_magnetic")}}:
        <div class="expect-div" @blur="saveData()">{{lysis.expected_magnetic_total_time}}</div>
      </div>
    </div>
    <div v-if="lysis.magnet_type=='sleeve'">
      <div class="step-name">
        {{$t("language.every_magnetic")}}:
        <input class="input-step-name" v-model="lysis.every_magnetic_time" @blur="saveData()" />
      </div>
      <div class="step-name">
        {{$t("language.liquid_level")}}:
        <input class="input-step-name" v-model="lysis.liquid_level_magnetic_time" @blur="saveData()" />
      </div>
      <div class="step-name">
        {{$t("language.cycle_1_99")}}:
        <input class="input-step-name" v-model="lysis.cycle" @blur="saveData()" />
      ...
      <div class="step-name">
        ...
        <input class="input-step-name" v-model="lysis.magnetic_speed" @blur="saveData()" />
      </div>
      <div class="step-name">
        {{$t("language.lowest_magnetic")}}:
        <input class="input-step-name" @blur="saveData()" v-model="lysis.lowest_magnetic_position" />
      </div>
      <div class="step-name">
        {{$t("language.dry_time")}}:
        <input class="input-step-name" v-model="lysis.drying_time" @blur="saveData()" />
      ...
      <div class="step-name">
        ...
        <input class="input-step-name" @blur="saveData()" v-model="lysis.drying_position" />
      </div>
      <div class="step-name">
        {{$t("language.expected_magnetic")}}:
        <div class="expect-div">{{lysis.expected_magnetic_total_time}}</div>
      </div>
      <div class="step-name">
      ...
      <div class="step-name">
        {{$t("language.mix_time")}}:
        <input class="input-step-name" @blur="saveData()" v-model="lysis.mix_time" />
      </div>
      <div class="step-name">
        {{$t("language.mix_height")}}:
        <input class="input-step-name" @blur="saveData()" v-model="lysis.mix_height" />
      </div>
      <div class="step-name">
        {{$t("language.mix_volume")}}:
        <input class="input-step-name" @blur="saveData()" v-model="lysis.mix_volume" />
      </div>
    </div>
  </div>
</template>
...
<script>
  export default {
    ...
    methods: {
      ...
      getData() {
        this.lysis = this.$store.getters.protocol.steps[this.order - 1]
      ...
      saveData() {
        ...
        protocol.steps[this.order - 1] = this.lysis
        this.$store.commit('setProtocol', protocol)
