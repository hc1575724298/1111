<template>
  <div>
    ...
    <div class="use-time">
      ...
      <div class="use-time-clear" v-if="$store.getters.user.group=='factory'">{{this.$t("language.clear")}}</div>
    </div>
    <div class="life-time">
      ...
      <input class="life-time-number" v-if="$store.getters.user.group=='factory'||$store.getters.user.group=='admin'"
        v-model="setting[1].value" style="background-color: white;" />
    </div>
    <div class="alarm">
    ...
    <div class="alarm-remain">
      ...
      <input class="alarm-time-number" v-model="setting[3].value" style="background-color: white;" />
    </div>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      saveAlarm() {
        // this.setting[2].value = this.setting[2].value ?1:0;
