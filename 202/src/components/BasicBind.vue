<template>
  <div class="model" v-if="title_type==1">
    <div class="step-name">
      {{$t("language.step")}}:
      <input class="input-step-name" v-model="bind.step_name" @blur="saveData()" />
    </div>
    ...
    <div class="step-name">
      ...
      <input class="input-step-name" v-model="bind.volume" @blur="saveData()" />
    </div>
    <div class="step-name">
      {{$t("language.mix_time")}}:
      <input class="input-step-name" v-model="bind.mix_time" @blur="saveData()" />
    </div>
    <div class="step-name">
      {{$t("language.mix_speed")}}:
      <input class="input-step-name" v-model="bind.mix_speed" @blur="saveData()" />
    </div>
    <div class="step-name">
      {{$t("language.mix_height")}}:
      <input class="input-step-name" v-model="bind.mix_height" @blur="saveData()" />
    </div>
    <div class="step-name">
      {{$t("language.mix_volume")}}:
      <input class="input-step-name" v-model="bind.mix_volume" @blur="saveData()" />
    </div>
    <div>
      <div v-if="bind.well!=2">
        ...
        <div class="step-name" style="margin-bottom: 10px;">
          ...
          <input class="input-step-name" v-model="bind.temperature" @blur="saveData()" />
        </div>
        <div class="step-name" style="margin-bottom: 10px;">
        ...
        <div class="warning" v-if="bind.pre_heating==1">
          <div class="warning-div" @click="selectHeatStatus"><img src="../images/login/remember_selected.png"
              class="img-ok" v-if="heat_stauts" /></div>
          <div>{{$t("language.elution_warning")}}</div>
          <input class="warning-input" v-model="bind.pre_heating_seconds" @blur="saveData()" />
        </div>
        <div class="step-name" style="margin-bottom: 10px;">
  ...
  <div v-else-if="title_type==2" class="model">
    ...
    <div v-if="bind.magnet_type=='tip'">
      <div class="step-name">
        {{$t("language.interval_stay")}}:
        <input class="input-step-name" v-model="bind.interval_stay_time" @blur="saveData()" />
      </div>
      <div class="step-name">
        {{$t("language.cycle_1_99")}}:
        <input class="input-step-name" v-model="bind.cycle" @blur="saveData()" />
      </div>
      <div class="step-name">
        {{$t("language.beat_speed")}}:
        <input class="input-step-name" v-model="bind.beat_speed" @blur="saveData()" />
      </div>
      <div class="step-name">
        {{$t("language.dry_time")}}:
        <input class="input-step-name" v-model="bind.drying_time" @blur="saveData()" />
      </div>
      <div class="step-name">
        {{$t("language.expected_magnetic")}}:
        <div class="expect-div" @blur="saveData()">{{bind.expected_magnetic_total_time}}</div>
      </div>
    </div>
    <div v-if="bind.magnet_type=='sleeve'">
      <div class="step-name">
        {{$t("language.every_magnetic")}}:
        <input class="input-step-name" v-model="bind.every_magnetic_time" @blur="saveData()" />
      </div>
      <div class="step-name">
        {{$t("language.liquid_level")}}:
        <input class="input-step-name" v-model="bind.liquid_level_magnetic_time" @blur="saveData()" />
      </div>
      <div class="step-name">
        {{$t("language.cycle_1_99")}}:
        <input class="input-step-name" v-model="bind.cycle" @blur="saveData()" />
      ...
      <div class="step-name">
        ...
        <input class="input-step-name" v-model="bind.magnetic_speed" @blur="saveData()" />
      </div>
      <div class="step-name">
        {{$t("language.lowest_magnetic")}}:
        <input class="input-step-name" @blur="saveData()" v-model="bind.lowest_magnetic_position" />
      </div>
      <div class="step-name">
        {{$t("language.dry_time")}}:
        <input class="input-step-name" v-model="bind.drying_time" @blur="saveData()" />
      ...
      <div class="step-name">
        ...
        <input class="input-step-name" @blur="saveData()" v-model="bind.drying_position" />
      </div>
      <div class="step-name">
        {{$t("language.expected_magnetic")}}:
        <div class="expect-div">{{bind.expected_magnetic_total_time}}</div>
      </div>
      <div class="step-name">
      ...
      <div class="step-name">
        {{$t("language.mix_time")}}:
        <input class="input-step-name" @blur="saveData()" v-model="bind.mix_time" />
      </div>
      <div class="step-name">
        {{$t("language.mix_height")}}:
        <input class="input-step-name" @blur="saveData()" v-model="bind.mix_height" />
      </div>
      <div class="step-name">
        {{$t("language.mix_volume")}}:
        <input class="input-step-name" @blur="saveData()" v-model="bind.mix_volume" />
      </div>
    </div>
  </div>
</template>
...
<script>
  export default {
    ...
    methods: {
      ...
      getData() {
        this.bind = this.$store.getters.protocol.steps[this.order - 1]
      ...
      saveData() {
        ...
        protocol.steps[this.order - 1] = this.bind
        this.$store.commit('setProtocol', protocol)
