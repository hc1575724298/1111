<template>
  <div class="model" v-if="title_type==1">
    <div class="step-name">
      {{$t("language.step")}}:
      <input class="input-step-name" v-model="custom.step_name" @blur="saveData()" />
    </div>
    ...
    <div class="step-name">
      ...
      <input class="input-step-name" v-model="custom.volume" @blur="saveData()" />
    </div>
    <div class="step-name">
      {{$t("language.mix_time")}}:
      <input class="input-step-name" v-model="custom.mix_time" @blur="saveData()" />
    </div>
    <div class="step-name">
      {{$t("language.mix_speed")}}:
      <input class="input-step-name" v-model="custom.mix_speed" @blur="saveData()" />
    </div>
    <div class="step-name">
      {{$t("language.mix_height")}}:
      <input class="input-step-name" v-model="custom.mix_height" @blur="saveData()" />
    </div>
    <div class="step-name">
      {{$t("language.mix_volume")}}:
      <input class="input-step-name" v-model="custom.mix_volume" @blur="saveData()" />
    </div>
    <div>
      <div v-if="custom.well!=2">
        ...
        <div class="step-name" style="margin-bottom: 10px;">
          ...
          <input class="input-step-name" v-model="custom.temperature" @blur="saveData()" />
        </div>
        <div class="step-name" style="margin-bottom: 10px;">
        ...
        <div class="warning" v-if="custom.pre_heating==1">
          <div class="warning-div" @click="selectHeatStatus"><img src="../images/login/remember_selected.png" class="img-ok" v-if="heat_stauts" />
          </div>
          <div>{{$t("language.elution_warning")}}</div>
          <input class="warning-input" v-model="custom.pre_heating_seconds" @blur="saveData()" />
        </div>
        <div class="step-name" style="margin-bottom: 10px;">
  ...
  <div v-else-if="title_type==2" class="model">
    ...
    <div v-if="custom.magnet_type=='tip'">
      <div class="step-name">
        {{$t("language.interval_stay")}}:
        <input class="input-step-name" v-model="custom.interval_stay_time" @blur="saveData()" />
      </div>
      <div class="step-name">
        {{$t("language.cycle_1_99")}}:
        <input class="input-step-name" v-model="custom.cycle" @blur="saveData()" />
      </div>
      <div class="step-name">
        {{$t("language.beat_speed")}}:
        <input class="input-step-name" v-model="custom.beat_speed" @blur="saveData()" />
      </div>
      <div class="step-name">
        {{$t("language.dry_time")}}:
        <input class="input-step-name" v-model="custom.drying_time" @blur="saveData()" />
      </div>
      <div class="step-name">
        {{$t("language.expected_magnetic")}}:
        <div class="expect-div" @blur="saveData()">{{custom.expected_magnetic_total_time}}</div>
      </div>
    </div>
    <div v-if="custom.magnet_type=='sleeve'">
      <div class="step-name">
        {{$t("language.every_magnetic")}}:
        <input class="input-step-name" v-model="custom.every_magnetic_time" @blur="saveData()" />
      </div>
      <div class="step-name">
        {{$t("language.liquid_level")}}:
        <input class="input-step-name" v-model="custom.liquid_level_magnetic_time" @blur="saveData()" />
      </div>
      <div class="step-name">
        {{$t("language.cycle_1_99")}}:
        <input class="input-step-name" v-model="custom.cycle" @blur="saveData()" />
      ...
      <div class="step-name">
        ...
        <input class="input-step-name" v-model="custom.magnetic_speed" @blur="saveData()" />
      </div>
      <div class="step-name">
        {{$t("language.lowest_magnetic")}}:
        <input class="input-step-name" @blur="saveData()" v-model="custom.lowest_magnetic_position" />
      </div>
      <div class="step-name">
        {{$t("language.dry_time")}}:
        <input class="input-step-name" v-model="custom.drying_time" @blur="saveData()" />
      ...
      <div class="step-name">
        ...
        <input class="input-step-name" @blur="saveData()" v-model="custom.drying_position" />
      </div>
      <div class="step-name">
        {{$t("language.expected_magnetic")}}:
        <div class="expect-div">{{custom.expected_magnetic_total_time}}</div>
      </div>
      <div class="step-name">
      ...
      <div class="step-name">
        {{$t("language.mix_time")}}:
        <input class="input-step-name" @blur="saveData()" v-model="custom.mix_time" />
      </div>
      <div class="step-name">
        {{$t("language.mix_height")}}:
        <input class="input-step-name" @blur="saveData()" v-model="custom.mix_height" />
      </div>
      <div class="step-name">
        {{$t("language.mix_volume")}}:
        <input class="input-step-name" @blur="saveData()" v-model="custom.mix_volume" />
      </div>
    </div>
  </div>
</template>
...
<script>
  export default {
    ...
    methods: {
      ...
      getData() {
        this.custom = this.$store.getters.protocol.steps[this.order - 1]
      ...
      saveData() {
        ...
        protocol.steps[this.order - 1] = this.custom
        this.$store.commit('setProtocol', protocol)
