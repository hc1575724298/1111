  ...
  <div class="users">
      ...
      <div class="user-content">
        <div class="user-siderbar">
          <div class="user-siderbar-option"  :class="{'user-option-selected':selectedOption==selected_user_option[0].id}" @click="selectUserOption(selected_user_option[0].id)">
            {{selected_user_option[0].name}}
          </div>
          <div class="user-siderbar-option"  :class="{'user-option-selected':selectedOption==selected_user_option[1].id}" @click="selectUserOption(selected_user_option[1].id)"
          v-if="this.$store.getters.user.group!='user'">
