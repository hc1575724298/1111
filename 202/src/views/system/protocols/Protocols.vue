<template>
  <div class="run-list">
    ...
    <div class="tube-info-button">
      <div class="button-div save" @click="manageRouter()">{{this.$t("language.manage")}}</div>
      <div class="button-div factory" @click="editProtocol()">{{this.$t("language.edit")}}</div>
    </div>
    ...
    data() {
      return {
        ...
        new_protocol: {
          ...
          cartridge: 7,
          pre_packaged: 0,
          elution_tube_info: "1.5ml_Allsheng",
          reagent_tube_info: "1.5ml_Allsheng",
          reagent_volume: 50,
          sample_tube_info: "10ml_Allsheng",
          sample_volume: 1000,
          remark: null,
          update: null
        },
